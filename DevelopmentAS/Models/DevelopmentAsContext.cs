...
//        => optionsBuilder.UseSqlServer();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDetalleOrdenProduccion).HasName("PK__DetalleO__47138A595F8CAEDD");
            ...
            entity.HasOne(d => d.NroOrdenProduccionNavigation).WithMany(p => p.DetalleOrdenProduccions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__DetalleOr__NroOr__160F4887");
        });
        ...
        {
            entity.HasKey(e => e.NroOrdenProduccion).HasName("PK__OrdenPro__E7D0CFDD87A1300E");
